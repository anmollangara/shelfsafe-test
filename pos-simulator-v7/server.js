...
app.listen(PORT, () => {
  console.log(`POS simulator running at http://localhost:${PORT}`)
  console.log('Demo login -> username: sam | password: password123')
  console.log(
    `Automatic stock mutation interval: ${SIMULATION_INTERVAL_MS / 1000}s`
  )
})
